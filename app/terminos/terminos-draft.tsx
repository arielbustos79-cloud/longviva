    ...
    <div style={{ minHeight: "100vh", background: "var(--crema)", fontFamily: "DM Sans, sans-serif" }}>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "56px 24px 80px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 36 }}>
          ...
          {/* PENDIENTE — revisión legal: quién es el titular. Pendiente hasta constituir LongViva SpA. */}
          ...
          {/* PENDIENTE — revisión legal: titularidad de propiedad intelectual. Pendiente hasta constituir LongViva SpA. */}
