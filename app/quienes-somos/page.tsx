      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "64px 24px 96px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 48 }}>
          ...
          <Bloque titulo="Lo que ofrecemos">
            VIVIAN, nuestra asistente conversacional, está disponible hoy en la web — cálida, directa y disponible cuando la necesites, para acompañarte en salud, bienestar y las decisiones del día a día. También te orientamos hacia los mejores servicios de telemedicina, bienestar, nutrición, ocio y farmacias. Nosotros te conectamos; los servicios los operan proveedores de confianza que seleccionamos para ti.
          </Bloque>

          <Bloque titulo="Cómo nos financiamos">
            LongVivIA es y será siempre 100% gratuita para quienes la usan. Nos financiamos con publicidad segmentada y con comisiones cuando te conectamos con proveedores de confianza en salud, bienestar y experiencias — nunca con cuotas ni cobros a nuestros usuarios.
          </Bloque>
