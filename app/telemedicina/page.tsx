...
// prevision === null  → nunca registró (mostrar banner "regístralo")
// prevision === "ninguna" → explícitamente sin previsión (mostrar genéricos, sin banner)
// prevision === valor específico → mostrar solo proveedores filtrados
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--crema)", fontFamily: "DM Sans, sans-serif" }}>
      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px 96px" }}>
        ...
        {/* Nunca registró previsión → invitar a registrar */}
        {prevision === null && (
          <div style={{ background: "white", borderRadius: 20, padding: "32px 28px", border: "1.5px solid var(--v5)", marginBottom: 32 }}>
            <p style={{ fontSize: 17, color: "var(--n2)", marginBottom: 16, fontWeight: 600 }}>
              Registra tu previsión para ver las opciones que calzan contigo
            </p>
            <p style={{ fontSize: 14, color: "var(--gris)", marginBottom: 20, lineHeight: 1.6 }}>
              Con tu previsión guardada, te mostramos solo los proveedores que aplican a tu situación — sin opciones irrelevantes.
            </p>
            ...
            <p style={{ fontSize: 13, color: "var(--gris)", marginTop: 20, marginBottom: 0 }}>
              Mientras tanto, aquí están todos los proveedores disponibles:
            </p>
          </div>
        )}

        {/* Previsión específica registrada → banner con nombre */}
        {prevision && prevision !== "ninguna" && (
        ...
        {/* Sin previsión explícita ("ninguna") → genéricos sin banner de invitación */}
        {prevision === "ninguna" && (
          <div style={{ background: "var(--v6)", borderRadius: 14, padding: "14px 20px", border: "1px solid var(--v5)", marginBottom: 32 }}>
            <p style={{ fontSize: 14, color: "var(--gris)", margin: 0, lineHeight: 1.6 }}>
              Mostrando opciones disponibles sin previsión específica. <Link href="/dashboard" style={{ color: "var(--v2)" }}>Actualizar en Mi panel</Link>
            </p>
          </div>
        )}
